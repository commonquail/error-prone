...
public class ScannerSupplierTest {
  ...
  @Test
  public void applyOverridesPrioritizesSeverityByCheckNameOverSeverityByCheckTag() {
    ScannerSupplier ss =
        ScannerSupplier.fromBugCheckerClasses(
            UnusedTypeParameter.class,
            ChainingConstructorIgnoresParameter.class,
    ...
    ErrorProneOptions epOptions =
        ErrorProneOptions.processArgs(
            ImmutableList.of("-Xep:ReferenceEquality:OFF", "-XepTag:FragileCode:ERROR"));
    ScannerSupplier overriddenScannerSupplier = ss.applyOverrides(epOptions);

    assertScanner(overriddenScannerSupplier)
        .hasEnabledChecks(UnusedTypeParameter.class, ChainingConstructorIgnoresParameter.class);
  }
